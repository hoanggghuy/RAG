...
if __name__ == "__main__":
    list_urls = ["https://hoanghamobile.com/dien-thoai/samsung-galaxy-z-fold7",
    "https://hoanghamobile.com/dien-thoai/samsung-galaxy-z-flip7",
    "https://hoanghamobile.com/dien-thoai/samsung-galaxy-s25",
    "https://hoanghamobile.com/dien-thoai/samsung-galaxy-z-fold6?#ins_sr=eyJwcm9kdWN0SWQiOiIzNTcwIn0=",]
    crawl = Crawl_Data_HHaMobile(urls=list_urls)
    crawl.run()
    crawl.save_to_json(path=r"C:\Users\ADMIN\Desktop\DATK1\data\data_crawl\Crawl_Data_HHaMobile.json")
